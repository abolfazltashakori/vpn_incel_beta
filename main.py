...
from services.vpn_handler import register_vpn_handlers
from services.payment_handler import register_payment_handlers
from services.admin_menu import register_admin_handlers
